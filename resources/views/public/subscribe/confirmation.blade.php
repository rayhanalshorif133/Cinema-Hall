...
<body class="">
    ...
    <div class="container subscribeBtn mt-[10rem]">
        <div class="w-full">
            <h3 class="text-white text-center">Subscribe to "Cinemahall"</h3>
            <br>
        ...
        <div class="justify-content-center ">
            ...
            <div class="col-md-4 text-center col-sm-4 my-3 mx-auto">
                <a href="{{route('subscription.confirmed')}}" class="btn btn-outline-success text-center btn-block btn-lg text-white">
                    Register
                </a>
            </div>
            <div class="col-md-4 text-center col-sm-4 my-3 mx-auto">
            ...
            <div class="col-md-4 text-center col-sm-4 my-3 mx-auto">
                <a href="#" class="btn btn-outline-danger text-center btn-block btn-lg text-white">
                    Back
                </a>
            </div>
        </div>
