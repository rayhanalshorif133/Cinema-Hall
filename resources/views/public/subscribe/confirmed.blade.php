...
<body class="">
                            ...
                            <ul class="dropdown-menu">
                                @foreach ($categories as $item)
                                    ...
                                    <li><a class="dropdown-item"
                                            href="{{ route('category.detail', [$item->id, $url]) }}">{{ $item->cat_name }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </li>
            ...
            <div id="nav-container">
                ...
                <div class="top-menu-bg">
                    ...
                    <a class="navbar-brand text-center d-block " href="{{ route('home') }}">
                        ...
                        <img src="{{ asset('assets/images/logo.png') }}" style="height: 40px; width: auto;"
                            alt="" title="">
                    </a>
                </div>
                <!-- top-menu-bg -->
    ...
    <main class="container subscribeBtn mt-[10rem]">
        <div class="justify-content-center text-center mx-auto">
        </div>
        <h3 class="text-white text-center">Subscription successful <br/> 🎉🎉🎉</h3>
        <div class="col-md-4 text-center col-sm-4 my-3 mx-auto">
            <a href="{{route('home')}}"
                class="btn btn-outline-danger text-center btn-block btn-lg text-white">
                Back
            </a>
        </div>
    </main>
